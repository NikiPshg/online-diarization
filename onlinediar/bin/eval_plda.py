...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--type", type=str, default="2cov", help="which type of plda to use, 2cov|kaldi"
    )
    parser.add_argument("--enroll_scp_path", type=str, help="enroll embeddings")
    parser.add_argument(
        "--indomain_scp_path", type=str, help="embeddings to compute meanvec"
    )
    ...
    plda.eval_sv(
        args.enroll_scp_path,
        args.utt2spk,
        args.test_scp_path,
        args.trial,
        args.score_path,
        args.multisession_avg,
