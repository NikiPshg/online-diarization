...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mdl_org", "-mo", type=str, required=True, help="Original PLDA mdl."
    )
    parser.add_argument(
        "--mdl_adp", "-ma", type=str, required=True, help="Adapted PLDA mdl."
    )
    parser.add_argument(
        "--mdl_format",
        "-mf",
    ...
    adapt_plda = plda.adapt(
        args.adp_scp, args.across_class_scale, args.within_class_scale
    )
